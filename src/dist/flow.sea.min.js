...
define("./util/tool",[],function(a,b,c){c.exports={isArray:Array.isArray||function(a){return Object.prototype.toString.call(a)=="[object Array]"},log:function(){if(window.console)if(console.log.apply)console.log.apply(console,arguments);else{var a=Array.prototype.slice.call(arguments,0),b=a.join(" ");console.log(b)}}}});

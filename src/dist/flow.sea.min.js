...
define("./input",["./util/class","./step","./util/extend"],function(a,b,c){var d=a("./util/class"),e=a("./step"),f=a("./util/extend"),g=d({extend:e,construct:function(a){a=a||{},this.callsuper(a),this._inputs=a.inputs||{},this._waiting=!1},methods:{_wait:function(a){this._waiting||(this._waiting=!0,a())},inputs:function(a){if(!a)return this._inputs;a.inputs&&f(this._inputs,a.inputs)}}});c.exports=g});

define("./index",["./util/class","./flow","./step","./condition","./input"],function(a,b,c){window.Flowjs={V:"1.2.7",Class:a("./util/class"),Flow:a("./flow"),Step:a("./step"),Condition:a("./condition"),Input:a("./input")}});
...
define("./util/tool",[],function(a,b,c){c.exports={isArray:Array.isArray||function(a){return Object.prototype.toString.call(a)=="[object Array]"},log:function(){if(window.console)if(console.log.apply)console.log.apply(console,arguments);else{var a=Array.prototype.slice.apply(arguments,0),b=a.join(" ");console.log(b)}}}});

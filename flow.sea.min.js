define("./index",["./util/class","./flow","./step","./condition","./input"],function(a,b,c){window.Flowjs={V:"1.2.3",Class:a("./util/class"),Flow:a("./flow"),Step:a("./step"),Condition:a("./condition"),Input:a("./input")}});
...
define("./util/tool",[],function(a,b,c){c.exports={isArray:Array.isArray||function(a){return Object.prototype.toString.call(a)=="[object Array]"},log:function(){window.console&&console.log.apply(console,arguments)}}});
define("./input",["./util/class","./condition","./util/extend"],function(a,b,c){var d=a("./util/class"),e=a("./condition"),f=a("./util/extend"),e=d({extend:e,construct:function(a){a=a||{},this.callsuper(a),this._inputs=a.inputs||{},this._binded=!1},methods:{_once:function(a){this._binded||(this._binded=!0,a())},inputs:function(a){var b={};return b.cases=a.inputs,this.cases(b)}}});c.exports=e});
